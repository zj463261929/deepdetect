...
CLNF::CLNF()
{
	...
	//LOG(INFO)<<parameters.model_location<<",  666666666666666";
...
{
	// Location of modules
	//cout<<clnf_location<<"  77777777777"<<endl;
	...
	//cout << root <<", root 0000000000000000000000000000000000"<<endl;
	// The main file contains the references to other files
	while (!locations.eof())
	{ 
		
		getline(locations, line);
		//cout<<locations<<", 0000000000000000000000"<<endl;
		...
		//cout << location<<", 55555555555555555555555555"<<endl;
