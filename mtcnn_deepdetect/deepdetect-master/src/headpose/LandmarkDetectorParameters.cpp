...
FaceModelParameters::FaceModelParameters()//vector<string> &arguments1)
{
	ofstream outfile("/home/zhangjing/deepdetect/deepdetect-master/build/main/out.txt", ofstream::app);  
	outfile<<"1111111111111111111111111";  
	outfile<<"\n";
	...
	LOG(INFO)<<model_location<<", model_location 111111111111111111111";/////////////////////
	outfile<<model_location;  
	outfile<<"\n";
	...
	LOG(INFO)<<model_location<<", model_location 111111111 222222";
	outfile<<model_location;  
	outfile<<"\n";
	outfile.close();
}
